...
class User extends \App\Entities\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entities\\User' . "\0" . 'id', '' . "\0" . 'App\\Entities\\User' . "\0" . 'name', '' . "\0" . 'App\\Entities\\User' . "\0" . 'email', 'password', '' . "\0" . 'App\\Entities\\User' . "\0" . 'posts', 'rememberToken'];
        }
    ...
    public function getAuthPasswordName()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAuthPasswordName', []);

        return parent::getAuthPasswordName();
    }
